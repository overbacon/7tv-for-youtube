...
3. Добавлен авто-подбор эмоутов. Сообщение надо начинать с символа ":"
...
6. Добавлен поиск эмоутов по всему 7tv введите три буквы в поиске меню → под своими эмоутами появится секция «7TV library» с результатами из всего 7tv

<img width="512" height="425" alt="image" src="https://github.com/user-attachments/assets/dc34c872-af89-4f44-abc5-53faa87aed4b" />

# 7tv-for-youtube
# 7TV for YouTube (Unofficial) 7TV для YouTube (Неофициально)


# КАЧАТЬ ЧЕРЕЗ [РЕЛИЗЫ](https://github.com/overbacon/7tv-for-youtube/releases)
# DOWNLOAD CLICK ON [RELEASES](https://github.com/overbacon/7tv-for-youtube/releases) 
